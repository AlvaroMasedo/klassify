...
<head>
    ...
    <title>404 - Página no encontrada | Klassify</title>
...
<body>
    <main class="error-card" role="main" aria-labelledby="error-title">
        <section class="error-hero">
            ...
            <h1 id="error-title" class="error-title">Página no encontrada</h1>
        </section>

        <section class="error-body">
            <p>
                La página que buscas no existe, se ha movido o se ha eliminado.
                Comprueba la URL o vuelve a una sección disponible de la plataforma.
            </p>
            ...
            <div class="error-meta">
                Si crees que esto es un fallo, vuelve atrás o contacta con soporte.
            </div>
        </section>
    </main>
</body>
