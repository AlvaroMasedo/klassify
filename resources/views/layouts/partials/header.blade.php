<header class="k-header">
    ...
    <div class="k-header-inner">
        <button class="mobile-menu-btn" type="button" aria-label="Abrir menú" title="Abrir menú">
            <span></span>
            <span></span>
            <span></span>
        </button>

        <a class="k-brand" href="{{ route('home') }}" title="Ir al inicio">
        ...
        <div class="k-search">
            <!--Afegir recurs-->
            <a href="{{ route('resources.create') }}" class="add-button" title="Añadir recurso">
            ...
            <form class="form">
                ...
                <button class="reset" type="reset" title="Limpiar búsqueda">
        ...
        <div class="k-header-actions">
            <!--Notificaciones-->
            <a href="{{ route('notifications.index') }}" class="notifications-button" title="Notificaciones">
            ...
            <div class="k-profile" tabindex="0">
                <button class="k-profile-btn" type="button" aria-haspopup="true" aria-expanded="false" title="Abrir menú de perfil">
            ...
            @else
            <a class="k-profile-btn" href="{{ route('login') }}" title="Iniciar sesión">Iniciar sesión</a>
            @endauth
        </div>
